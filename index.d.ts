 ...
 */
export function eventGetOccurrences(
  eventName: string,
  callback: Callback
): void;
 ...
 */
export function profileGetProperty(
  propertyName: string,
  callback: Callback
): void;
 ...
 */
export function profileGetCleverTapAttributionIdentifier(
 ...
 */
export function getInboxMessageForId(
  messageId: string,
  callback: Callback
): void;
 ...
 */
export function getProductConfigString(key: string, callback: Callback): void;
 ...
 */
export function getProductConfigBoolean(key: string, callback: Callback): void;
 ...
 */
export function getNumber(key: string, callback: Callback): void;
